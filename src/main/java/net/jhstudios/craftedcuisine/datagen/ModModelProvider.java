package net.jhstudios.craftedcuisine.datagen;

import net.fabricmc.fabric.api.datagen.v1.FabricDataOutput;
import net.fabricmc.fabric.api.datagen.v1.provider.FabricModelProvider;
import net.jhstudios.craftedcuisine.block.ModBlocks;
import net.jhstudios.craftedcuisine.block.custom.CornCropBlock;
import net.jhstudios.craftedcuisine.block.custom.RiceCropBlock;
import net.jhstudios.craftedcuisine.block.custom.TomatoCropBlock;
import net.jhstudios.craftedcuisine.block.custom.VanillaBeanCropBlock;
