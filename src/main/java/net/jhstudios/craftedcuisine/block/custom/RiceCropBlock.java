package net.jhstudios.craftedcuisine.block.custom;
...
public class RiceCropBlock extends CropBlock implements Waterloggable {
    ...
    public boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        boolean validSoil = below.isOf(net.minecraft.block.Blocks.FARMLAND)
                || below.isOf(net.minecraft.block.Blocks.DIRT)
