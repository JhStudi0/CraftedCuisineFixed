package net.jhstudios.craftedcuisine.block;

import net.fabricmc.fabric.api.itemgroup.v1.ItemGroupEvents;
import net.jhstudios.craftedcuisine.CraftedCuisine;
import net.jhstudios.craftedcuisine.block.custom.*;
...
public class ModBlocks {
    ...
    private static Block registerBlockWithoutBlockItem(String name, Block block) {
        return Registry.register(Registries.BLOCK, Identifier.of(CraftedCuisine.MOD_ID, name), block);
    }
    ...
    private static void registerBlockItem(String name, Block block) {
        Registry.register(Registries.ITEM, Identifier.of(CraftedCuisine.MOD_ID, name),
                new BlockItem(block, new Item.Settings()));
    }

    public static void registerModBlocks() {
        CraftedCuisine.LOGGER.info("Registering Mod Blocks for " + CraftedCuisine.MOD_ID);
